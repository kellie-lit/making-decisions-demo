...
//Realizing that his backpack is going to be too full to add other essentials, Jon decides to take his sword out and place it on his belt. Remove this sword from the backpack. (splice,shift and pop are like picking something up out of the array and walking over to the trash if you assign it to something else you set that item there like on a desk or drawer but if you don't assign it to anything you just throw it away)
...
console.log(backpack.length - 1) //this is to get rid of an element 
...
for (let i=0; i < backpack.length2; i++){
    console.log(backpack2[i])
}

// check items in backpack2 
